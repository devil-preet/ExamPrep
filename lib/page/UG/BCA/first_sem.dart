            ...
            child: Column(
              ...
              children: [
                ...
                Subject_tile(
                  ...
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>PDFScreen(filename: 'it-sem1')));
                  },
                ),
                Subject_tile(
                  ...
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>PDFScreen(filename: 'oa-sem1')));
                  },
                ),
                Subject_tile(
                  ...
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>PDFScreen(filename: 'c-sem1')));
                  },
                ),
                Subject_tile(
                  title: 'Punjabi',
